...
public class Activity_ForgotPasswordOTP2 extends AppCompatActivity {
    private PinView pvOTPInput;
    private String codeBySystem;
    private Button btnVerifyOTP;
    private FirebaseAuth mAuth; // FirebaseAuth instance
    TextView tvRecognizeAccount;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_forgot_password_otp2);
        ...
        tvRecognizeAccount = findViewById(R.id.tvRecognizeAccount);
        tvRecognizeAccount.setText("Welcome back, " + fullName + "!");
        ...
        btnVerifyOTP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!code.isEmpty() && code.length() == 6) {
                    ...
                    Toast.makeText(Activity_ForgotPasswordOTP2.this, "Please enter valid code", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallBacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(@NonNull FirebaseException e) {
            ...
            Toast.makeText(Activity_ForgotPasswordOTP2.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Intent intent = new Intent(Activity_ForgotPasswordOTP2.this, Activity_ForgotPassword.class);
                            intent.putExtra("mobileNumber", getIntent().getStringExtra("mobileNumber"));
                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(intent);
                        } else {
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                Toast.makeText(Activity_ForgotPasswordOTP2.this, "Verification not completed! Try again.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
